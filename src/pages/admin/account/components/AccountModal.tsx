            ...
            <div className="modal-content max-w-modal-lg bg-surface-base rounded-xl shadow-2xl p-6 relative fade-in">
                ...
                <form onSubmit={handleFormSubmit} className="flex flex-col gap-4">
                            ...
                            >
                                <div className="flex items-center gap-2 overflow-hidden w-full">
                                    ...
                                    <span className="truncate w-full text-left text-sm">
                                        {formData.bankName ? `${formData.bankCode} - ${formData.bankName}` : <span className="text-text-secondary">Chọn ngân hàng</span>}
                                    </span>
                                </div>
                    ...
                    <div className="flex flex-col gap-2 mt-2">
                        ...
                        {/* <label className="flex items-center gap-2 text-sm font-medium text-text-secondary cursor-pointer mt-2">
                            <input
                                type="checkbox"
                                ...
                                className="w-4 h-4 text-primary rounded"
                            />
                            Ghim tài khoản (Ưu tiên hiển thị)
                        </label> */}
                    </div>
